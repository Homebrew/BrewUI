...
public struct SelfUpgradeLaunchNotice {
    ...
    public var storageKey: String {
        "\(defaultsKeyPrefix).lastUpgradeOutcome"
    }

    /// Non-`nil` exactly once per completed attempt.
    public func consume() -> SelfUpgradeOutcome? {
        ...
        return SelfUpgradeOutcome(rawValue: raw) ?? .succeeded
    }

    public func mark(_ outcome: SelfUpgradeOutcome) {
