...
/// center. It is long-lived so the parsed report survives navigating away from and back to the Doctor tab;
/// `load()` refreshes in the background, keeping the prior report on screen while it runs (stale-while-revalidate).
