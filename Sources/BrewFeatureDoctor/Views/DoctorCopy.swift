...
/// Doctor copy that must match `brew doctor` word for word. Deliberately not localized: it is a
/// verbatim echo of the CLI, and translating it would contradict the output shown beside it.
enum DoctorCopy {
