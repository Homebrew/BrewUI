...
private struct DiscoverPackageDetailDependenciesSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: BrewSpacing.xs) {
            PackageDetailSectionHeading(title: String(localized: "Dependencies", bundle: #bundle, comment: "Package detail section heading"))
...
private struct DiscoverPackageInstallSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: BrewSpacing.sm) {
            PackageDetailSectionHeading(title: String(localized: "Install", bundle: #bundle, comment: "Package detail section heading"))
            VStack(alignment: .leading, spacing: BrewSpacing.md) {
                CommandBlockView(
                    command: viewModel.installCommand,
                    summaryText: String(localized: "Installs this package on your Mac", bundle: #bundle, comment: "Command block summary above brew install"),
                )
