...
struct InstalledPackageDetailView: View {
    ...
    private func packageDetailsSections(viewModel: InstalledPackageDetailViewModel) -> some View {
        ...
        PackageRelationshipSection(
            title: String(localized: "Dependencies", bundle: #bundle, comment: "Package detail section heading"),
            relationships: viewModel.dependencyRelationships,
            emptyText: String(localized: "No dependencies.", bundle: #bundle, comment: "Package detail: empty dependency list"),
            dotStyle: .neutral,
            onSelectInstalledPackage: onSelectInstalledPackage,
        )
        PackageDetailSectionDivider()
        ...
        VStack(alignment: .leading, spacing: BrewSpacing.sm) {
            ...
            VStack(alignment: .leading, spacing: BrewSpacing.md) {
                CommandBlockView(
                    ...
                    summaryText: String(localized: "Uninstalls this package from this Mac", bundle: #bundle, comment: "Command block summary above brew uninstall"),
                )
        ...
        VStack(alignment: .leading, spacing: BrewSpacing.sm) {
            ...
            VStack(alignment: .leading, spacing: BrewSpacing.md) {
                CommandBlockView(
                    ...
                    summaryText: String(localized: "Upgrades this package to the latest available version", bundle: #bundle, comment: "Command block summary above brew upgrade"),
                )
