...
struct AXIDTests {
    @Test func `static identifiers keep their wire format`() {
        let identifiers = [
            ...
            .installedExportBrewfileButton,
            .brewfileExportSheet,
            .brewfileExportChooseLocationButton,
            .brewfileExportSubmitButton,
            .upgradesScreen,
            .upgradesList,
        ...
        #expect(identifiers == [
            ...
            "installed.list",
            "installed.search",
            "installed.export.brewfile",
            "brewfile.export.sheet",
            "brewfile.export.chooseLocation",
            "brewfile.export.submit",
            "upgrades.screen",
            "upgrades.list",
            "upgrades.refresh",
            "discover.screen",
