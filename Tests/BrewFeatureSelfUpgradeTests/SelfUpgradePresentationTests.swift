//
//  SelfUpgradePresentationTests.swift
...
struct SelfUpgradePresentationTests {
    private func presentation(running: String = "1.4.2", latest: String?) -> SelfUpgradePresentation {
        SelfUpgradePresentation(
            status: SelfUpgradeStatus(
                runningVersion: running,
                latestVersion: latest,
                homepageURL: nil,
                isUpgradeAvailable: latest != nil,
            ),
        )
    }
