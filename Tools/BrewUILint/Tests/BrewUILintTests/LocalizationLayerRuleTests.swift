...
struct LocalizationLayerRuleTests {
    private static let localizing = [
        ...
        #"let s = Swift.String(localized: "Homebrew command failed.", bundle: #bundle, comment: "c")"#,
        #"let s = Foundation.NSLocalizedString("Homebrew command failed.", comment: "")"#,
        #"let t = SwiftUI.Text("Homebrew command failed.", bundle: #bundle, comment: "c")"#,
    ]
